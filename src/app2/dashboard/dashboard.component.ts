...
export class DashboardComponent implements OnInit {
  ...
  constructor(private router: Router, private service: AppService, public popup: Popup, private route: ActivatedRoute) {
  ...
  ngOnInit() {
    ...
    this.service.getuserRole(value).subscribe(data => {
      ...
      this.service.getStaffDataById(vals).subscribe(dats => {
        ...
        this.realrole = localStorage.getItem('realRole');
        if (utype == 'adm') {
